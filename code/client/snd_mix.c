...
void S_TransferStereo16 (unsigned long *pbuf, int endtime)
{
    ...
    // write a linear blast of samples
        ...
        //      CL_WriteAVIAudioFrame( (byte *)snd_out, snd_linear_count << 1 ); // snd_linear_count * (dma.samplebits/8) // TODO
    }
}
...
void S_TransferPaintBuffer(int endtime)
{
    ...
    pbuf = (unsigned long *)dma.buffer;// TODO possible alignment fault
