...
//typedef void (*CODEC_LOADASYNC)(const char *filename, sfxHandle_t sfx, sfxHandle_t *cgs_media);
...
//void S_CodecLoadAsync(const char *filename, sfxHandle_t sfx, sfxHandle_t *cgs_media);
...
//void S_WAV_CodecLoadAsync(const char *filename, sfxHandle_t sfx, sfxHandle_t *cgs_media);
...
//void S_OGG_CodecLoadAsync(const char *filename, sfxHandle_t sfx, sfxHandle_t *cgs_media);
