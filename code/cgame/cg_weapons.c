...
static void CG_RegisterWeapon( int weaponNum ) {
    ...
    switch ( weaponNum ) {
        case WP_GAUNTLET:
            ...
            weaponInfo->firingSound   = S_RegisterSound( "sound/weapons/melee/fstrun.ogg" );
            weaponInfo->flashSound[0] = S_RegisterSound( "sound/weapons/melee/fstatck.ogg" );
            break;

        case WP_LIGHTNING:
            MAKERGB( weaponInfo->flashDlightColor, 0.6f, 0.6f, 1.0f );

            weaponInfo->readySound            = S_RegisterSound( "sound/weapons/melee/fsthum.ogg" );
            weaponInfo->firingSound           = S_RegisterSound( "sound/weapons/lightning/lg_hum.ogg" );
            weaponInfo->flashSound[0]         = S_RegisterSound( "sound/weapons/lightning/lg_fire.ogg" );

            cgs.media.sfx_lghit1              = S_RegisterSound( "sound/weapons/lightning/lg_hit.ogg" );
            cgs.media.sfx_lghit2              = S_RegisterSound( "sound/weapons/lightning/lg_hit2.ogg" );
            cgs.media.sfx_lghit3              = S_RegisterSound( "sound/weapons/lightning/lg_hit3.ogg" );
...
#ifdef MISSIONPACK
        case WP_CHAINGUN:
            weaponInfo->firingSound = S_RegisterSound( "sound/weapons/vulcan/wvulfire.ogg", qfalse );
            MAKERGB( weaponInfo->flashDlightColor, 1, 1, 0 );
            weaponInfo->flashSound[0] = S_RegisterSound( "sound/weapons/vulcan/vulcanf1b.ogg", qfalse );
            weaponInfo->flashSound[1] = S_RegisterSound( "sound/weapons/vulcan/vulcanf2b.ogg", qfalse );
            weaponInfo->flashSound[2] = S_RegisterSound( "sound/weapons/vulcan/vulcanf3b.ogg", qfalse );
            weaponInfo->flashSound[3] = S_RegisterSound( "sound/weapons/vulcan/vulcanf4b.ogg", qfalse );
        ...
        case WP_MACHINEGUN:
            ...
            weaponInfo->flashSound[0]       = S_RegisterSound( "sound/weapons/machinegun/machgf1b.ogg" );
            weaponInfo->flashSound[1]       = S_RegisterSound( "sound/weapons/machinegun/machgf2b.ogg" );
            weaponInfo->flashSound[2]       = S_RegisterSound( "sound/weapons/machinegun/machgf3b.ogg" );
            weaponInfo->flashSound[3]       = S_RegisterSound( "sound/weapons/machinegun/machgf4b.ogg" );
            weaponInfo->ejectBrassFunc      = CG_MachineGunEjectBrass;
            cgs.media.bulletExplosionShader = RE_RegisterShader( "bulletExplosion" );
            break;
        ...
        case WP_SHOTGUN:
            ...
            weaponInfo->flashSound[0]  = S_RegisterSound( "sound/weapons/shotgun/sshotf1b.ogg" );
            weaponInfo->ejectBrassFunc = CG_ShotgunEjectBrass;
            break;

        case WP_ROCKET_LAUNCHER:
            weaponInfo->missileModel     = RE_RegisterModel( "models/ammo/rocket/rocket.md3" );
            weaponInfo->missileSound     = S_RegisterSound( "sound/weapons/rocket/rockfly.ogg" );
            ...
            weaponInfo->flashSound[0]       = S_RegisterSound( "sound/weapons/rocket/rocklf1a.ogg" );
            cgs.media.rocketExplosionShader = RE_RegisterShader( "rocketExplosion" );
            break;

#ifdef MISSIONPACK
        case WP_PROX_LAUNCHER:
            weaponInfo->missileModel = RE_RegisterModel( "models/weaphits/proxmine.md3" );
            weaponInfo->missileTrailFunc = CG_GrenadeTrail;
            weaponInfo->wiTrailTime = 700;
            weaponInfo->trailRadius = 32;
            MAKERGB( weaponInfo->flashDlightColor, 1, 0.70f, 0 );
            weaponInfo->flashSound[0] = S_RegisterSound( "sound/weapons/proxmine/wstbfire.ogg", qfalse );
        ...
        case WP_GRENADE_LAUNCHER:
            ...
            weaponInfo->wiTrailTime          = 700;
            weaponInfo->trailRadius          = 32;
            weaponInfo->flashSound[0]        = S_RegisterSound( "sound/weapons/grenade/grenlf1a.ogg" );
            cgs.media.grenadeExplosionShader = RE_RegisterShader( "grenadeExplosion" );
            break;
...
//          weaponInfo->missileSound = S_RegisterSound( "sound/weapons/nailgun/wnalflit.ogg", qfalse );
            weaponInfo->trailRadius      = 16;
            weaponInfo->wiTrailTime      = 250;
            weaponInfo->missileModel     = RE_RegisterModel( "models/weaphits/nail.md3" );
            weaponInfo->flashSound[0]    = S_RegisterSound( "sound/weapons/nailgun/wnalfire.ogg", qfalse );
            break;
#endif
...
//          weaponInfo->missileModel = cgs.media.invulnerabilityPowerupModel;
            ...
            weaponInfo->missileSound        = S_RegisterSound( "sound/weapons/plasma/lasfly.ogg" );
            weaponInfo->flashSound[0]       = S_RegisterSound( "sound/weapons/plasma/hyprbf1a.ogg" );
        ...
        case WP_RAILGUN:
            ...
            weaponInfo->readySound        = S_RegisterSound( "sound/weapons/railgun/rg_hum.ogg" );
            weaponInfo->flashSound[0]     = S_RegisterSound( "sound/weapons/railgun/railgf1a.ogg" );
        ...
        case WP_BFG:
            ...
            weaponInfo->readySound       = S_RegisterSound( "sound/weapons/bfg/bfg_hum.ogg" );
            weaponInfo->flashSound[0]    = S_RegisterSound( "sound/weapons/bfg/bfg_fire.ogg" );
...
static float    CG_MachinegunSpinAngle( centity_t *cent ) {
    ...
    if ( cent->pe.barrelSpinning == !(cent->currentState.eFlags & EF_FIRING) ) {
        ...
        if ( cent->currentState.weapon == WP_CHAINGUN && !cent->pe.barrelSpinning ) {
            S_StartSound( NULL, cent->currentState.number, CHAN_WEAPON, S_RegisterSound( "sound/weapons/vulcan/wvulwind.ogg", qfalse ) );
        }
#endif
    }
...
void CG_AddPlayerWeapon( refEntity_t *parent, playerState_t *ps, centity_t *cent, int team ) {
    ...
    R_LerpTag(&lerped, parent->hModel, parent->oldframe, parent->frame, 1.0 - parent->backlerp, "tag_weapon");
    ...
    if ( ps || cg.renderingThirdPerson ||
        ...
        if ( weapon->flashDlightColor[0] || weapon->flashDlightColor[1] || weapon->flashDlightColor[2] ) {
            RE_AddLightToScene( flash.origin, 300 + (rand()&31), weapon->flashDlightColor[0], weapon->flashDlightColor[1], weapon->flashDlightColor[2] );
        }
    }
}
...
static void CG_ShotgunPellet( vec3_t start, vec3_t end, int skipNum ) {
    ...
    if ( sourceContentType == destContentType ) {
        ...
        CM_BoxTrace( &trace, end, start, NULL, NULL, 0, CONTENTS_WATER, 0 );
        CG_BubbleTrail( start, trace.endpos, 32 );
    } else if ( destContentType & CONTENTS_WATER ) {
        trace_t trace;

        CM_BoxTrace( &trace, start, end, NULL, NULL, 0, CONTENTS_WATER, 0 );
...
hit splashes
this should match G_ShotgunPattern
================
*/
static void CG_ShotgunPattern( vec3_t origin, vec3_t origin2, int seed, int otherEntNum ) {
    ...
    if ( qtrue ) {
        int n   = DEFAULT_SHOTGUN_COUNT;
        float d = DEFAULT_SHOTGUN_SPREAD / 2.;
        int c   = 3;
...
void CG_Tracer( vec3_t source, vec3_t dest ) {
    ...
    // addPolyS ToScene exists where the last arg is the number of polys, otherwise just 1
