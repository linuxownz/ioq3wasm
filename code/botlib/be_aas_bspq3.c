...
{
    UNUSED(absmins); UNUSED(absmaxs); UNUSED(entnum); UNUSED(modelnum);
    return NULL;
}
...
{
    UNUSED(absmins); UNUSED(absmaxs); UNUSED(list); UNUSED(maxcount);
    return 0;
}
...
{
    UNUSED(start); UNUSED(end); UNUSED(endpos); UNUSED(red); UNUSED(green); UNUSED(blue);
    return 0;
}
