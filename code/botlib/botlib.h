...
//bot AI library functions

//print messages from the bot library
void        BotImport_Print(int type, char *fmt, ...) __attribute__ ((format (printf, 2, 3)));
...
//memory allocation
void       *BotImport_GetMemory(int size);        // allocate from Zone
void        BotImport_FreeMemory(void *ptr);       // free memory from Zone
int         BotImport_AvailableMemory(void);       // available Zone memory
void       *BotImport_HunkAlloc(int size);        // allocate from hunk
//file system access
int         FS_FOpenFileByMode( const char *qpath, fileHandle_t *file, fsMode_t mode );
...
//extern aas_export_t aas;
//Elementary Action functions
//extern ea_export_t ea;
//AI functions
//extern ai_export_t ai;
...
void *GetBotLibAPI( int apiVersion, void *import );
