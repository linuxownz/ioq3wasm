...
{
    BotImport_BotClientCommand(client, va("say %s", str) );
...
{
    BotImport_BotClientCommand(client, va("say_team %s", str));
...
{
    BotImport_BotClientCommand(client, va("tell %d, %s", clientto, str));
} //end of the function EA_SayTeam
//===========================================================================
//
// Parameter:               -
...
{
    BotImport_BotClientCommand(client, va("use %s", it));
...
{
    BotImport_BotClientCommand(client, va("drop %s", it));
...
{
    BotImport_BotClientCommand(client, va("invuse %s", inv));
...
{
    BotImport_BotClientCommand(client, va("invdrop %s", inv));
...
{
    BotImport_BotClientCommand(client, command);
...
{
    UNUSED(client); UNUSED(thinktime);
...
int EA_Setup(void)
{
    float LibVarValue(char *, char *);
    int maxclients = (int) LibVarValue("maxclients", "128");
    //initialize the bot inputs
    botinputs = (bot_input_t *) GetClearedHunkMemory( maxclients * sizeof(bot_input_t));
