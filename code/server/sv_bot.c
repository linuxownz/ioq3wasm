...
void BotDrawDebugPolygons(void (*drawPoly)(int color, int numPoints, float *points), int value) {
    ...
    if (bot_enable && bot_debug->integer) {
        ...
        /*botlib_*/Export_BotLibVarSet("bot_highlightarea", bot_highlightarea->string);
        /*botlib_*/BotExportTest(parm0, NULL, svs.clients[0].gentity->r.currentOrigin,
...
==================
*/
/*static*/ __attribute__ ((format (printf, 2, 3))) void BotImport_Print(int type, char *fmt, ...)
{
    char str[2048];
    va_list ap;
...
int SV_BotLibSetup( void ) {
    ...
    /*botlib_*/Export_BotLibVarSet( "basegame", com_basegame->string );

    return /*botlib_*/Export_BotLibSetup();
}
...
int SV_BotLibShutdown( void ) {
    ...
    return /*botlib_*/Export_BotLibShutdown();
}
