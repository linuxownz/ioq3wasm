...
void SV_SendServerCommand( client_t *cl, const char *fmt, ...) __attribute__ ((format (printf, 2, 3)));
...
// define a string constant for json
// #ifndef JSON
// # define JSON(name,value) #name":"#value","
// #else
// # error JSON already defined?
// #endif
