...
#else
# include "~/Installs/emscripten/emsdk/upstream/emscripten/cache/sysroot/include/emscripten.h"
# include "~/Installs/emscripten/emsdk/upstream/emscripten/cache/sysroot/include/emscripten/fetch.h"
#endif
...
#define Q3_VERSION PRODUCT_NAME " " PRODUCT_VERSION " " PRODUCT_DATE " " GIT_REV
...
typedef unsigned int sfxHandle_t;
...
int Q_isnan(float x);
  ...
  // its address
  // TODO I changed (vec) to &(vec) testing required
...
// TODO use browser supplied functions if available...
//
