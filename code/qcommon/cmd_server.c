...
#if ! defined(SERVER)
# error qcommon/cmd_server.c trying to compile client
#endif
...
/*
============
Cbuf_ExecuteTextToSock
============
*/

qboolean g_output_to_clientsock = qfalse;

void Cbuf_ExecuteTextToSock (int exec_when, const char *text)
{
    g_output_to_clientsock = qtrue;
    Cbuf_ExecuteText ( exec_when, text );
    g_output_to_clientsock = qfalse;
}
