...
#elif defined(CLIENT)
    void        (*trace)( trace_t *result, const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end, int skipNumber, int mask );
#endif
...
#define DF_NO_PLAYERCLIP       512
#define DF_NOFIREOFFSPAWN     1024
