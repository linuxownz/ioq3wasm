...
void G_LogPrintf( const char *fmt, ... ) __attribute__ ((format (printf, 1, 2)));
void SendScoreboardMessageToAllClients( void );
void G_Printf( const char *fmt, ... ) __attribute__ ((format (printf, 1, 2)));
void G_Error( const char *fmt, ... ) __attribute__ ((noreturn, format (printf, 1, 2)));
...
void    Cbuf_ExecuteText( int exec_when, const char *text ); // void    trap_SendConsoleCommand( int exec_when, const char *text );
...
void    SV_LocateGameData( gentity_t *gEnts, int numGEntities, int sizeofGEntity_t, playerState_t *gameClients, int sizeofGameClient );
void    trap_DropClient( int clientNum, const char *reason );
void SV_GameSendServerCommand ( int clientNum, const char *text );// void    trap_SendServerCommand( int clientNum, const char *text );
