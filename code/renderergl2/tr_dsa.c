...
void GL_BindNullTextures(void)
{
    int i;
#if 0
    if (0) // TODO no direct access glRefConfig.directStateAccess)
    {
...
#if 0
DO NOT REMOVE may be able to use if I use extension ( if exists )
...
int GL_BindMultiTexture(GLenum texunit, GLenum target, GLuint texture) // TODO test
{
