...
static void RB_SurfaceAxis( void ) {
    ...
    glLineWidth( 3 );
    glBegin( GL_LINES ); // commented out
    glColor3f( 1,0,0 ); // commented out
    glVertex3f( 0,0,0 ); // commented out
    glVertex3f( 16,0,0 ); // commented out
    glColor3f( 0,1,0 ); // commented out
    glVertex3f( 0,0,0 ); // commented out
    glVertex3f( 0,16,0 ); // commented out
    glColor3f( 0,0,1 ); // commented out
    glVertex3f( 0,0,0 ); // commented out
    glVertex3f( 0,0,16 ); // commented out
    glEnd(); // commented out
    glLineWidth( 1 ); // commented out
#endif
}
...
void RB_SurfaceVaoMdvMesh(srfVaoMdvMesh_t * surface)
{
    ...
    if (surface->mdvModel->numFrames > 1)
    {
        ...
        {
            glBindBuffer(GL_ARRAY_BUFFER, surface->vao->vertexesVBO); // TODO UNCOMMENTED OUT ...
        }
