...
static void AutospriteDeform( void ) {
	...
	if ( tess.numVertexes & 3 ) {
		Com_Printf( "Autosprite shader %s had odd vertex count\n", tess.shader->name );
	}
	if ( tess.numIndexes != ( tess.numVertexes >> 2 ) * 6 ) {
		Com_Printf( "Autosprite shader %s had odd index count\n", tess.shader->name );
	}
...
static void Autosprite2Deform( void ) {
	...
	if ( tess.numVertexes & 3 ) {
		Com_Printf( "Autosprite2 shader %s had odd vertex count\n", tess.shader->name );
	}
	if ( tess.numIndexes != ( tess.numVertexes >> 2 ) * 6 ) {
		Com_Printf( "Autosprite2 shader %s had odd index count\n", tess.shader->name );
	}
